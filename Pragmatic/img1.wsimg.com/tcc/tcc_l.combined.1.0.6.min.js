...
// create cookie or reset the expiration time
return b||c?(b||(b=a.guid.generateGuid()),c||(c=a.guid.generateGuid())):b=c=a.guid.generateGuid(),a.utility.setCookie(a.doc,"_tccl_visitor",b,525600,"index-2.html",null),a.utility.setCookie(a.doc,"_tccl_visit",c,30,"index-2.html",null),{visitor:b,visit:c}}var h=a.hasOwnProperty("version")?a.version:"not.set",i=a.hasOwnProperty("baseHost")?a.baseHost:"godaddy.com",j=a.hasOwnProperty("imgSitePath")?a.imgSitePath:"/t/1/tl/event",k=a.utility.getBeaconEndpoint(i,j),l=a.utility.rand(),m=a.hasOwnProperty("trfdData")?a.trfdData:{};return a.debugMode,{cmdLogEvent:d,cmdLogPerf:b,cmdLogPage:c}},f=function(){var b=a.utility.debug;b("TrackerQueue object created.");var c=[];this.push=function(c,d){
